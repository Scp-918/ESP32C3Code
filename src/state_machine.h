...
enum SystemState {
    ...
    STATE_WAIT_AD7680,          // 等待AD7680转换完成
    STATE_READ_AD7680,          // 读取AD7680数据
    STATE_WAIT_ADS1220,         // 等待ADS1220数据就绪
    STATE_READ_ADS1220,         // 读取ADS1220数据
...
extern volatile bool dataReadyAFE;
